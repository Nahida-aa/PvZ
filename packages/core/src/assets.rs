...
pub struct GameAssets {
    ...
    pub card_cactus: Handle<Image>,
    pub card_blover: Handle<Image>,
...
impl Plugin for GameAssetsPlugin {
    fn build(&self, app: &mut App) {
        ...
        let assets = GameAssets {
            ...
            card_cactus: server.load("graphics/Cards/card_cactus.png"),
            card_blover: server.load("graphics/Cards/card_blover.png"),
            ...
            lawn_mower: server.load("items/lawnmower/reanim/LawnMower_body.png"),
            lawn_mower_sound: server.load("sound/lawnmower.ogg"),
            mower_body: server.load("items/lawnmower/reanim/LawnMower_body.png"),
            mower_wheelpiece: server.load("items/lawnmower/reanim/LawnMower_wheelpiece.png"),
            mower_wheel1: server.load("items/lawnmower/reanim/LawnMower_wheel1.png"),
            mower_wheel2: server.load("items/lawnmower/reanim/LawnMower_wheel2.png"),
            mower_wheelshine: server.load("items/lawnmower/reanim/LawnMower_wheelshine.png"),
            mower_pull: server.load("items/lawnmower/reanim/LawnMower_pull.png"),
            mower_engine: server.load("items/lawnmower/reanim/LawnMower_engine.png"),
