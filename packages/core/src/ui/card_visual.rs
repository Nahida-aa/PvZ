...
pub fn card_image_handle(plant: &str, assets: &GameAssets) -> Handle<Image> {
    match plant {
        ...
        "CherryBomb" => assets.card_cherrybomb.clone(),
        "WallNut" => assets.card_wallnut.clone(),
        "PotatoMine" => assets.card_potatomine.clone(),
        "SnowPea" => assets.card_snowpea.clone(),
        "Chomper" => assets.card_chomper.clone(),
        "RepeaterPea" => assets.card_repeaterpea.clone(),
        "PuffShroom" => assets.card_puffshroom.clone(),
        "SunShroom" => assets.card_sunshroom.clone(),
        "FumeShroom" => assets.card_fumeshroom.clone(),
        "GraveBuster" => assets.card_gravebuster.clone(),
        "HypnoShroom" => assets.card_hypnoshroom.clone(),
        "IceShroom" => assets.card_iceshroom.clone(),
        "DoomShroom" => assets.card_doomshroom.clone(),
        "LilyPad" => assets.card_lilypad.clone(),
        "Squash" => assets.card_squash.clone(),
        "ThreePeaShooter" => assets.card_threepeashooter.clone(),
        "TangleKlep" => assets.card_tangleklep.clone(),
        "Jalapeno" => assets.card_jalapeno.clone(),
        "Spikeweed" => assets.card_spikeweed.clone(),
        ...
        "GiantWallNut" => assets.card_giantwallnut.clone(),
